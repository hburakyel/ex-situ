...
export interface ApiGeocodeGeocode extends Schema.CollectionType {
  collectionName: 'geocodes';
  info: {
    displayName: 'Geocode';
    pluralName: 'geocodes';
    singularName: 'geocode';
  };
  options: {
...
export interface ApiMuseumObjectMuseumObject extends Schema.CollectionType {
  collectionName: 'museum_objects';
  info: {
    description: '';
    displayName: 'museum-object';
    pluralName: 'museum-objects';
    singularName: 'museum-object';
  };
  options: {
...
export interface ApiStatsStats extends Schema.CollectionType {
  ...
  attributes: {
    ...
    institution_name: Attribute.String;
    publishedAt: Attribute.DateTime;
    total_objects: Attribute.Integer;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::stats.stats',
      'oneToOne',
