...
async function markDraftIfImgUrlEmpty() {
  try {
    let page = 1;
    let totalPages = 1;
    ...
    console.log('Completed updating entries to draft where img_url is empty.');
  } catch (error) {
    console.error('Error updating entries:', error);
  }
}

markDraftIfImgUrlEmpty();
