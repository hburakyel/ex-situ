          ...
          btn.addEventListener("click", (e) => {
            ...
            this._popup.innerHTML = `
              ...
              <div style="display:flex;flex-direction:column;gap:6px">
                ...
                <div style="font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace;font-size:11px;line-height:1.4;color:#999">
                  Data may be incomplete. <a href="https://github.com/hburakyel/ex-situ/issues/new" target="_blank" rel="noopener noreferrer" style="color:#999;text-decoration:none">Report issue ↗</a>
                </div>
              </div>
            `
